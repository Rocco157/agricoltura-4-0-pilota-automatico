...
class AreaCoverageProblem:
    def __init__(self, area_coordinates, obstacle_coordinates):
        ...
        self.cells = []  # Lista per contenere le sottocelle (dopo la decomposizione)

    def decomponi_area(self, metodo="trapezoidale"):
        """
        Decompone l'area in sottocelle utilizzando il metodo specificato.
        Attualmente supporta solo la decomposizione "trapezoidale".
        """
...
if __name__ == '__main__':
    # Esempio 1: Poligono semplice con ostacolo
    print("--- Esempio 1: Poligono semplice con ostacolo ---")
    area_coords_1 = [(0, 0), (10, 0), (10, 10), (0, 10), (0,0)]
    obstacle_coords_1 = [[(3, 3), (7, 3), (7, 7), (3, 7), (3,3)]]

    problem1 = AreaCoverageProblem(area_coords_1, obstacle_coords_1)
    problem1.decomponi_area()
    ...
    ax1.set_title(f"Decomposizione Trapezoidale (Esempio 1) - {len(problem1.cells)} Celle")
    ...
    # Esempio 2: Poligono concavo senza ostacoli
    print("--- Esempio 2: Poligono concavo senza ostacoli ---")
    area_coords_2 = [(0, 0), (10, 0), (10, 5), (5, 5), (5, 10), (0, 10), (0,0)]
    obstacle_coords_2 = []

    problem2 = AreaCoverageProblem(area_coords_2, obstacle_coords_2)
    problem2.decomponi_area()
    ...
    ax2.set_title(f"Decomposizione Trapezoidale (Esempio 2) - {len(problem2.cells)} Celle")
    plt.xlabel("X Coordinate")
    plt.ylabel("Y Coordinate")
    plt.grid(True)
    plt.show()
    ...
    # Esempio 3: Poligono con un "buco"
    print("--- Esempio 3: Poligono con un 'buco' ---")
    area_coords_3 = [(0, 0), (10, 0), (10, 10), (0, 10), (0,0)]
    obstacle_coords_3 = [[(2, 2), (8, 2), (8, 8), (2, 8), (2,2)]] # Un buco grande

    problem3 = AreaCoverageProblem(area_coords_3, obstacle_coords_3)
    problem3.decomponi_area()
    ...
    ax3.set_title(f"Decomposizione Trapezoidale (Esempio 3) - {len(problem3.cells)} Celle")
    plt.xlabel("X Coordinate")
    plt.ylabel("Y Coordinate")
    plt.grid(True)
    plt.show()
    ...
    # --- Esempio 4: Poligono a forma di stella con ostacoli multipli ---
    print("--- Esempio 4: Poligono a forma di stella con ostacoli multipli ---")
    area_coords_4 = [
    ...
    problem4 = AreaCoverageProblem(area_coords_4, obstacle_coords_4)
    problem4.decomponi_area()
    ...
    ax4.set_title(f"Decomposizione Trapezoidale (Esempio 4) - {len(problem4.cells)} Celle")
    plt.xlabel("X Coordinate")
    plt.ylabel("Y Coordinate")
    plt.grid(True)
    plt.show()
    ...
    # --- Esempio 5: Poligono irregolare complesso con ostacoli sparsi ---
    print("--- Esempio 5: Poligono irregolare complesso con ostacoli sparsi ---")
    area_coords_5 = [
    ...
    problem5 = AreaCoverageProblem(area_coords_5, obstacle_coords_5)
    problem5.decomponi_area()
    ...
    ax5.set_title(f"Decomposizione Trapezoidale (Esempio 5) - {len(problem5.cells)} Celle")
    plt.xlabel("X Coordinate")
    plt.ylabel("Y Coordinate")
    plt.grid(True)
    plt.show()
    ...
    # --- Esempio 6: Area a L con ostacoli complessi ---
    print("--- Esempio 6: Area a L con ostacoli complessi ---")
    area_coords_6 = [
    ...
    problem6 = AreaCoverageProblem(area_coords_6, obstacle_coords_6)
    problem6.decomponi_area()
    ...
    ax6.set_title(f"Decomposizione Trapezoidale (Esempio 6) - {len(problem6.cells)} Celle")
    plt.xlabel("X Coordinate")
    plt.ylabel("Y Coordinate")
    plt.grid(True)
    plt.show()
    ...
    # Esempio 7: Area a C con ostacoli allungati ---
    print("--- Esempio 7: Area a C con ostacoli allungati ---")
    area_coords_7 = [
    ...
    problem7 = AreaCoverageProblem(area_coords_7, obstacle_coords_7)
    problem7.decomponi_area()
    ...
    ax7.set_title(f"Decomposizione Trapezoidale (Esempio 7) - {len(problem7.cells)} Celle")
    plt.xlabel("X Coordinate")
    plt.ylabel("Y Coordinate")
    plt.grid(True)
    plt.show()
    ...
    # --- Esempio 8: Area a forma di "U" con ostacoli circolari e triangolari ---
    print("--- Esempio 8: Area a forma di 'U' con ostacoli circolari e triangolari ---")
    area_coords_8 = [
    ...
    problem8 = AreaCoverageProblem(area_coords_8, obstacle_coords_8)
    problem8.decomponi_area()
    ...
    ax8.set_title(f"Decomposizione Trapezoidale (Esempio 8) - {len(problem8.cells)} Celle")
    plt.xlabel("X Coordinate")
    plt.ylabel("Y Coordinate")
    plt.grid(True)
    plt.show()
    ...
    # --- Esempio 9: Area complessa con ostacoli a forma di L e irregolari ---
    print("--- Esempio 9: Area complessa con ostacoli a forma di L e irregolari ---")
    area_coords_9 = [
    ...
    problem9 = AreaCoverageProblem(area_coords_9, obstacle_coords_9)
    problem9.decomponi_area()
    ...
    ax9.set_title(f"Decomposizione Trapezoidale (Esempio 9) - {len(problem9.cells)} Celle")
    plt.xlabel("X Coordinate")
    plt.ylabel("Y Coordinate")
    plt.grid(True)
    plt.show()
